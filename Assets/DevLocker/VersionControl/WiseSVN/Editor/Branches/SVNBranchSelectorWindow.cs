...
namespace DevLocker.VersionControl.WiseSVN.Branches
{
	...
	public class SVNBranchSelectorWindow : EditorWindow
	{
		...
		[MenuItem("Window/Version Control/SVN/\U0001F4CD  Branch Selector", false, SVNContextMenusManager.WindowMenuPriority + 2)]
		...
		private void InitializeStyles()
		{
			...
			Preferences.SVNPreferencesWindow.MigrateBorderStyleToUIElementsIfNeeded(BorderStyle);
